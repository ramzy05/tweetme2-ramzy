...
class TweetTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='ram',password='somepassword')
        self.userb = User.objects.create_user(username='jun',password='somepassword')
    ...
    def test_action_like(self):
        ...
        self.assertEqual(response.status_code,200)
        likes_counts = response.json().get('likes')
        self.assertEqual(likes_counts,1)
    ...
    def test_action_unlike(self):
        ...
        self.assertEqual(response.status_code,200)
        likes_counts = response.json().get('likes')
        self.assertEqual(likes_counts,0)
